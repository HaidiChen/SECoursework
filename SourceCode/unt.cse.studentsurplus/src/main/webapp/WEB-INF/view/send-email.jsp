...
<body>
	<form action="sendEmail" method="POST">
		...
		<center>
      <button style="color:white;" onclick="submit" class="button">Send email</button>
		</center>
		<div id="last" class="container-fluid " style="margin-top: 10%;">
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-xs-12 col-sm-12">
					<p class="text-left;" style="margin-top: 30px;">
					<h4>Follow us on</h4>
					<img id="footer" src="${pageContext.request.contextPath}/resources/images/fb.png"> <img
						id="footer" src="${pageContext.request.contextPath}/resources/images/ins.png"> <img id="footer"
